    ...
    return (
        <div className="p-10 w-full flex flex-col lg:flex-row items-center lg:items-start justify-center space-x-4 mx-auto space-y-4 lg:space-y-0 ">
            ...
            <div className="flex space-x-4">
                ...
                <Skeleton className=" inline lg:hidden h-[200px]  w-[200px] rounded-md " />
            ...
            <Skeleton className=" w-[380px] h-[40px] sm:w-[580px] rounded-md " />
            <Skeleton className=" w-[380px] h-[40px] sm:w-[300px] rounded-md " />
            <Skeleton className=" w-[380px] h-[40px] sm:h-[650px] sm:w-[500px] rounded-md " />
            </div>
